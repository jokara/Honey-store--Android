 ...
 */
public class PocetnaKupacFragment extends Fragment {


    ArrayList<Item> listOfItems= new ArrayList<>();
    MyViewModel myViewModel;

    public PocetnaKupacFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(R.layout.fragment_pocetna_kupac, container, false);
        ...
        mAdapter = new MyAdapter(listOfItems,this);
        recyclerView.setAdapter(mAdapter);


        /*myViewModel.toggle.observe(getActivity(), new Observer<String>() {
            @Override
            public void onChanged(String s) {
                myViewModel.setToggle("nije_novo");
                if (s.equals("novo")) {
