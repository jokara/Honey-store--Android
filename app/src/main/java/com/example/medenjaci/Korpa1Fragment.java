 ...
 */
public class Korpa1Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v =inflater.inflate(R.layout.fragment_korpa1, container, false);
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            case R.id.pocetna:
                                ...
                                navController.navigate(R.id.action_korpa1Fragment_to_pocetnaKupacFragment);
                                return true;
                            case R.id.azuriraj:
                                navController= Navigation.findNavController(view);
                                navController.navigate(R.id.action_korpa1Fragment_to_azuriranjeFragment);
                                return true;
                            case R.id.korpa:
                                return true;
                            case R.id.odjava:
                                navController= Navigation.findNavController(view);
                                navController.navigate(R.id.action_korpa1Fragment_to_prijavaFragment);
                                return true;
                            default:
                                return false;
                        }
        ...
        mAdapter = new MyAdapter2(listOfItems,this);
        recyclerView.setAdapter(mAdapter);


        Button korpaPotvrda = v.findViewById(R.id.korpaPotvrda);
        korpaPotvrda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getActivity(),"Uspešno ste naručili!",Toast.LENGTH_SHORT).show();
                NavController navController= Navigation.findNavController(view);
                navController.navigate(R.id.action_korpa1Fragment_to_pocetnaKupacFragment);
            }
        });
